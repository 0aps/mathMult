(function() {
    ...
    var init = {
        ...
        surroundings: {
            rightWall: function() {
                add.box({
                    x: window.innerWidth/30,        // 740 / 30 + 1.1
                    y: window.innerHeight/30 ,        // 380px / 30 / 2
            ...
            ground: function() {
                add.box({
                    x: window.innerWidth/30/2,        // 740 / 30 / 2
                    y: window.innerHeight/30 + 1.1,
                    height: 2,
                    width:window.innerWidth/30 ,     // 740 / 30
                    isStatic: true
                });
            },
            leftWall: function() {
